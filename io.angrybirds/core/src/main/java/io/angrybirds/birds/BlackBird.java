...
public class BlackBird extends Bird {
    ...
    private float explosionRadius = 1f; // Adjust based on your world scale
    private float explosionForce = 5f; // Adjust based on your needs
    private World world;
    ...
    public void ability() {
        ...
        if (!isExploding && isLaunched() && !isDead()) {
            isExploding = true;
            explode();
        }
    }
