...
public abstract class Bird implements CollisionHandler.Damageable {
    ...
    public void createBody(World world, float x, float y) {
        ...
        bodyDef.position.set(x/PPM, y/PPM);  // Set the initial position of the bird in the world
        ...
        shape.setRadius(this.sprite.getWidth()/(4*PPM));  // Set the radius of the circle (RADIUS should be defined elsewhere)
