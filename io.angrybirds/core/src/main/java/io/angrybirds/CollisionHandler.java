...
public class CollisionHandler implements ContactListener {
    ...
    private void initializeDamageFactors() {
        ...
        damageFactors.put("Bird-Platform", 0.05f);  // Birds take more damage from platforms

        // Block collisions
        damageFactors.put("Block-Block", 0.1f);    // Normal damage between blocks
        damageFactors.put("Block-Pig", 0.08f);      // Blocks do moderate damage to pigs
        damageFactors.put("Block-Platform", 0.05f); // Blocks take less damage from platforms
