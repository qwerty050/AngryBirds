...
public class WoodBlock extends Block {
    private static final float WOODBLOCK_HEALTH = 150/1.4f;
    private static final int WOODBLOCK_POINTS = 500;

    public WoodBlock(World world, float x, float y, float width, float height) {
        super(WOODBLOCK_HEALTH, world, x, y, width, height,WOODBLOCK_POINTS);
    }
